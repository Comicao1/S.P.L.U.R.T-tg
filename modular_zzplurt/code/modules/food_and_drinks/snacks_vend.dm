...
/obj/item/food/snacks/jellybean/Initialize(mapload)
	if(!chosen_color)
...
/obj/item/food/snacks/jellybean/lewd
	desc = "A rather large sized, colorful bean full of sugar... or not...?"

/obj/item/food/snacks/jellybean/lewd/Initialize(mapload)
	if(!prob(50))
		return ..()
...
/obj/item/storage/fancy/jellybean_bowl
	...
	spawn_type = /obj/item/food/snacks/jellybean

/obj/item/storage/fancy/jellybean_bowl/ComponentInitialize()
	. = ..()
	atom_storage.max_slots = 10
	atom_storage.can_hold = typecacheof(list(/obj/item/food/snacks/jellybean))
...
/obj/item/storage/fancy/jellybean_pack
	...
	icon = 'modular_zzplurt/icons/obj/food/food.dmi'
	icon_state = "bean_bag"
	spawn_type = /obj/item/food/snacks/jellybean/lewd

/obj/item/storage/fancy/jellybean_pack/ComponentInitialize()
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	atom_storage.max_slots = 27
	atom_storage.can_hold = typecacheof(list(/obj/item/food/snacks/jellybean/lewd))
	atom_storage.rustle_sound = FALSE
